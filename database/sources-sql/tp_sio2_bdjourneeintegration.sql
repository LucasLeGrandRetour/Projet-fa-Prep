...
INSERT INTO Competence VALUES ('2', 'CSS');
INSERT INTO Competence VALUES ('3', 'PHP');
...
GRANT SELECT, INSERT ON `tp_sio2_bdjourneeintegration`.`Developpeur` TO 'JI_Dev_Write'@'%';
GRANT SELECT, DELETE ON `tp_sio2_bdjourneeintegration`.`Developpeur` TO 'JI_Dev_Supp'@'%';
GRANT SELECT, UPDATE ON `tp_sio2_bdjourneeintegration`.`Developpeur` TO 'JI_Dev_Update'@'%';

GRANT SELECT ON `tp_sio2_bdjourneeintegration`.`Competence` TO 'JI_Comp_Read'@'%';
GRANT SELECT, DELETE ON `tp_sio2_bdjourneeintegration`.`Competence` TO 'JI_Comp_Write'@'%';

...
DROP USER IF EXISTS 'JI_Comp_Delete'@'%';

CREATE USER 'JI_Comp_Delete'@'%' IDENTIFIED BY 'pwdJIPourComp_D';

DROP USER IF EXISTS 'JI_Comp_Update'@'%';

CREATE USER 'JI_Comp_Update'@'%' IDENTIFIED BY 'pwdJIPourComp_U';

DROP USER IF EXISTS 'JI_Dev_Update'@'%';

CREATE USER 'JI_Dev_Update'@'%' IDENTIFIED BY 'pwdJIPourDev_U';

DROP USER IF EXISTS 'JI_Dev_Delete'@'%';

CREATE USER 'JI_Dev_Delete'@'%' IDENTIFIED BY 'pwdJIPourDev_D';
